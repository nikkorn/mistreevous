 ...
 */
export declare function isDecoratorNode(node: NodeDefinition): node is DecoratorDefinition;
/**
 ...
 */
export declare function isCompositeNode(node: NodeDefinition): node is CompositeDefinition;
/**
